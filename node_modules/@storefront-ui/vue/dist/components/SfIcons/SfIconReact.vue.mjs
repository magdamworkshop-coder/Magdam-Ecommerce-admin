import { defineComponent as t, openBlock as s, createBlock as m, unref as o, withCtx as n, createElementVNode as e } from "vue";
...
const p = /* @__PURE__ */ t({
  ...
  setup(a) {
    return (q, c) => (s(), m(o(r), {
      ...
      default: n(() => c[0] || (c[0] = [
        e("path", { d: "M13.96 11.952c0 1.099-.877 1.99-1.96 1.99s-1.96-.891-1.96-1.99.877-1.989 1.96-1.989 1.96.89 1.96 1.99" }, null, -1),
        e("path", {
          "fill-rule": "evenodd",
